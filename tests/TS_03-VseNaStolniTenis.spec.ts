...
test("TC_03_01 - Sorting tables by price", async ({ page }) => {
...
test('TC_03_02 - Filter tables by brand', async ({ page }) => {
...
test('TC_03_03 - Check contact info of all stores', async ({ page }) => {
...
test('TC_03_04 - Language translations', async ({ page }) => {
